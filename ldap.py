...
class LDAPManager:
    def __init__(self, server_url: str = 'ldap.eco.dvo.ru', base_dn: str = 'ou=users,dc=eco,dc=dvo,dc=ru', admin_dn: str = 'cn=Manager,dc=eco,dc=dvo,dc=ru', admin_password: str = os.getenv('LDAP_PASS')):
        self.server_url = server_url
        self.admin_dn = admin_dn
        self.admin_password = admin_password
        self.users_base_dn = base_dn
